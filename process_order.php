...
class PDF extends FPDF
{
    ...
    function AddLogo()
    {
        $this->Image('storelogo.jpg', 10, 6, 30); // Adjust the path and size as needed
    ...
    function Footer()
    {
        ...
        $this->Cell(0, 03, 'Mandar Sankhe 8980277 | Susmi Rani 8961944 | Dhruvinkumar Jayani 8969031', 0, 1, 'C');
